...
Window_BattleStatus.prototype.drawGaugeArea = function(rect, actor) {
    ...
    var wy = rect.y + rect.height - this.lineHeight() - 20;
    var wymod = (Imported.YEP_CoreEngine) ? Yanfly.Param.GaugeHeight : 20;
    var wymod = Math.max(16, wymod);
    this.drawActorHp(actor, rect.x, wy - wymod, rect.width);
    this.drawActorMp(actor, rect.x, wy + 5, rect.width);
