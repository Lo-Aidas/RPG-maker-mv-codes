...
Window_SynthesisList.prototype.spacing = function() {
    return 8;
};
...
Window_SynthesisList.prototype.drawItemName = function(item, x, y, width) {
    if (!item) return;
    if (true||$gameSystem.hasSynthed(item)) {
...
Window_SynthesisList.prototype.drawItemNumber = function(item, wx, wy, ww) {
    this.drawText($gameParty.numItems(item), wx, wy + this.itemHeight() - 35, ww, 'right');
    return;
